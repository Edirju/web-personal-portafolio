...
// Movimiento de entrada de la seccion de Info
...
quienSoyFoto && quienSoyFoto.addEventListener('mouseenter', () => {
  ...
  gsap.set(quienSoyFotoFoto, {
    attr: {src: "../assets/img/carpi-foto-a-2.png"}, 
    duration: 2
  })
...
quienSoyFoto && quienSoyFoto.addEventListener('mouseleave', () => {
  gsap.set(quienSoyFotoFoto, {
    attr: { src: "../assets/img/carpi-foto-a.png"},
      duration: .5
  })
  gsap.to(quienSoyFoto, .4, {
    scale: 1,
